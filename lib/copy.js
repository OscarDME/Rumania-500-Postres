...
export const copy = {
  ...
  hero: {
    ...
    badge: "Carte nouă de rețete · +3.200 de cursanți",
    headline: {
    ...
    subheadline:
      "Descoperă 500 de rețete de prăjituri moi, pufoase și delicioase, complet fără gluten, lactate și zahăr, pentru a te bucura de fiecare înghițitură fără durere, vinovăție sau restricții.",
    ctaLabel: "DA, VREAU CARTEA",
    ...
    floatingBadges: {
      speed: { icon: "⏱️", top: "Gata în", bottom: "20 min" },
  ...
  benefits: {
    ...
    items: [
      { icon: "🎂", title: "500 de arome ca să nu te plictisești niciodată" },
      { icon: "✨", title: "Textură perfectă chiar și fără gluten" },
      { icon: "🌾", title: "Nu ai nevoie de făinuri speciale" },
      { icon: "⚡", title: "Prăjituri gata în 20 de minute" },
      { icon: "💚", title: "Fără lapte și fără zahăr" },
      { icon: "📖", title: "Mod de preparare explicat pas cu pas" },
    ],
  },

  samples: {
    kicker: "Încearcă-le mai întâi",
    headline: "PRĂJITURI INCREDIBIL DE DELICIOASE (VARIANTA CLEAN):",
  ...
  moreRecipesCta: {
    ...
    ctaLabel: "DESCARCĂ EXEMPLARUL MEU",
  },

  testimonials: {
    kicker: "Dovezi reale",
    headline: "VEZI CE SPUN CEI CARE AU CUMPĂRAT-O DEJA",
  ...
  categories: {
    ...
    groups: [
      ...
      {
        title: "100 de Prăjituri faimoase de pe TikTok",
        items: [
          { src: "/preview/1-7.webp", alt: "Prăjitură de pe TikTok 1" },
          { src: "/preview/2-6.webp", alt: "Prăjitură de pe TikTok 2" },
          { src: "/preview/3-5-1.webp", alt: "Prăjitură de pe TikTok 3" },
          { src: "/preview/4-3.webp", alt: "Prăjitură de pe TikTok 4" },
        ],
      },
      {
  ...
  bonuses: {
    ...
    items: [
      ...
      },
      {
        ...
        name: "REȚETE DE GOGOȘI SĂNĂTOASE",
  ...
  audience: {
    ...
    items: [
      ...
      "Sunt la regim pentru diabet",
    ],
  },

  finalCta: {
    flagline: "Primii 100 de clienți primesc 20 de lecții video gratuite",
    headline: "CARTEA CU 500 DE PRĂJITURI DE LA CHEF MARIA ®",
  ...
  delivery: {
    ...
    items: [
      ...
      { icon: "🚫", text: "Și pe tabletă." },
      { icon: "♾️", text: "Acces pe viață: Împreună cu noile rețete." },
  ...
  guarantee: {
    kicker: "Fără riscuri",
    headline: "ÎNCEARCĂ FĂRĂ NICIUN RISC — Garanție necondiționată de 60 de zile.",
    body: "Ai 60 de zile la dispoziție să le testezi. Dacă rețetele nu te conving, îți voi returna banii până la ultimul ban. Fără complicații. Fără stres.",
    alt: "Ștampilă garanție necondiționată 60 de zile",
    image: { src: "/guarantee-badge.webp", alt: "60 de zile garanție" },
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Poți alege varianta preferată: cu fructe (banane sau curmale), cu miere sau cu îndulcitori precum stevia și eritritol. În fiecare rețetă este specificată cantitatea exactă pentru fiecare opțiune.",
      },
      {
